    ...
    <div class="container mx-auto px-4 pt-24 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div class="bg-white rounded-lg shadow p-6 border shadow-xl hover:shadow-lg hover:shadow-orange-500 transition duration-300">
                ...
                <div class="mt-4">
                    <a href="{{ route('users.index') }}" class="font-bold inline-block text-orange-500 hover:text-orange-800 transition duration-300">Ver Usuarios</a>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6 border shadow-xl hover:shadow-lg hover:shadow-orange-500 transition duration-300">
                ...
                <div class="mt-4">
                    <a href="{{ route('posts.index') }}" class="font-bold inline-block text-orange-500 hover:text-orange-800 transition duration-300">Ver Publicaciones</a>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6 bborder shadow-xl hover:shadow-lg hover:shadow-orange-500 transition duration-300">
                ...
                <div class="mt-4">
                    <a href="{{ route('comments.index') }}" class="font-bold inline-block text-orange-500 hover:text-orange-800 transition duration-300">Ver Comentarios</a>
                </div>
            </div>
        </div>
    </div>
