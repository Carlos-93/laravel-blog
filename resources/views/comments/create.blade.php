        ...
        <article class="mb-12 p-6 rounded-lg w-3/5">
            ...
            <form action="{{ route('comments.store') }}" method="POST">
                ...
                <div class="flex justify-center">
                    <input type="submit" value="Añadir Comentario" class="bg-orange-500 hover:bg-orange-400 text-white font-bold py-1.5 px-2.5 rounded cursor-pointer transition duration-300 ease-in-out">
                </div>
            </form>
        </article>
    </div>
